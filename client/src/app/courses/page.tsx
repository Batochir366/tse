      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <h1 className="text-xl font-bold tracking-tight text-foreground">TSE Academy</h1>
          </Link>
          ...
          <div className="flex items-center gap-3">
            {user && (
              ...
              >
                ...
                >
                  {user.avatar ? (
                    <Image src={user.avatar} alt="User Avatar" width={36} height={36} className="object-cover w-full h-full" />
                  ) : (
                      ...
                      <div className="p-5 flex-1 flex flex-col">
                        ...
                        {!(hasEntitlement && !course.isFree) && (
                          ...
                          >
                            ...
                            <span
                              className={`px-4 py-2 rounded-xl text-sm font-semibold ${course.isFree
