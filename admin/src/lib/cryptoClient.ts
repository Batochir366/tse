...
/** Matches backend `utils/crypto.ts` encrypt layout: iv(16) | tag(16) | ciphertext */
...
/**
 * If the body is `{ data: "<base64>" }` from encryptResponse middleware, decrypt
 * and return the inner JSON. Otherwise return the body unchanged.
 */
